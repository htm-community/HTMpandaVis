...
COL_CELL_ACTIVE = LColor(1.0, 0.7, 0.7, 1.0)#pink
...
COL_CELL_FALSE_PREDICTED = LColor(1.0, 0.0, 0.0, 1.0)#red
COL_CELL_PRESYNAPTIC_FOCUS = LColor(0.5, 0.8, 1.0, 1.0)# bright blue

COL_COLUMN_ONEOFCELLACTIVE = LColor(1.0, 0.7, 0.7, 1.0) # pink
COL_COLUMN_ONEOFCELLCORRECTLY_PREDICTED = LColor(0.0, 1.0, 0.0, 1.0) # green
COL_COLUMN_ONEOFCELLFALSE_PREDICTED = LColor(1.0, 0.0, 0.0, 1.0)#red
